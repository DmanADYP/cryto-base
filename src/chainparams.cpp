...
public:
    CMainParams() {
        ...
        // vSeeds.emplace_back("seed-a.fnFlunce.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.fnFluncetools.com");
        // vSeeds.emplace_back("dnsseed.fnFluncepool.org");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x6e, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x6e, 0x88, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.fnFluncetools.com");
        // vSeeds.emplace_back("seed-b.fnFlunce.loshan.co.uk");
